...
from models.model.vlnce import resnet
from models.model.vlnce.resnet_policy import ResNetEncoder
    ...
    def __init__(
        ...
        if "rgb" in observation_space.spaces:
            ...
            if obs_size_0 != 224 or obs_size_1 != 224:
                logger.warn(
                    f"WARNING: TorchVisionResNet50: observation size ({obs_size_0}, {obs_size_1}) is not conformant to expected ResNet input size [3x224x224]"
                )
        ...
        self.cnn = torchvision_models.resnet50(pretrained=True)
        ...
        if not self.spatial_output:
            ...
            self.spatial_embeddings = nn.Embedding(512, 7 * 7)
