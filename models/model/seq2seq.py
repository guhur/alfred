...
class Module(nn.Module):
    ...
    def run_train(self, splits, args=None, optimizer=None):
        ...
        for epoch in trange(0, args.epoch, desc="epoch"):
            ...
            self.summary_writer.add_scalar(
                "valid_seen/total_loss", m_valid_seen["total_loss"], valid_seen_iter
            )
            ...
            if total_valid_unseen_loss < best_loss["valid_unseen"]:
                ...
                with open(fpred, "wt") as f:
                    json.dump(
                        self.make_debug(p_valid_unseen, valid_unseen), f, indent=2
                    )
    ...
    def make_debug(self, preds, data):
        ...
        for task in data:
            ...
            debug[i] = {
                "lang_goal": ex["turk_annotations"]["anns"][ex["ann"]["repeat_idx"]][
                    "task_desc"
                ],
                "action_low": [
